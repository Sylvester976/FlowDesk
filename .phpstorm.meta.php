...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./media/data/FlowDesk/public/storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./media/data/FlowDesk/public/storage','fortify.guard',
...
'login','logout','password.confirm','password.confirmation',
...
'livewire.update','livewire.upload-file','livewire.preview-file','profile.edit','profile.update','profile.destroy',
'dashboard','employees','employee_add','save_staff','register','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','password.confirm',
'password.update','storage.local',);
        registerArgumentsSet('views', 
'auth.confirm-password','auth.forgot-password','auth.forgot-password3','auth.login','auth.login3',
'auth.register','auth.reset-password','auth.reset-password3','auth.verify-email','components.action-message',
'components.app-logo','components.app-logo-icon','components.application-logo','components.auth-header','components.auth-session-status',
...
'components.layouts.auth.card','components.layouts.auth.simple','components.layouts.auth.split','components.modal','components.nav-link',
'components.placeholder-pattern','components.primary-button','components.responsive-nav-link','components.secondary-button','components.settings.layout',
'components.text-input','dashboard.dashboard','e60dd9d2c3a62d619c9acb38f20d5aa5::icon.book-open-text','e60dd9d2c3a62d619c9acb38f20d5aa5::icon.chevrons-up-down','e60dd9d2c3a62d619c9acb38f20d5aa5::icon.folder-git-2',
'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.layout-grid','e60dd9d2c3a62d619c9acb38f20d5aa5::navlist.group','employees.add_employee','employees.all_employees','flux.icon.book-open-text',
'flux.icon.chevrons-up-down','flux.icon.folder-git-2','flux.icon.layout-grid','flux.navlist.group','layouts.app',
'layouts.base','layouts.guest','layouts.navigation','livewire.auth.confirm-password','livewire.auth.forgot-password',
...
'livewire.settings.two-factor.recovery-codes','partials.head','partials.settings-heading','profile.edit','profile.partials.delete-user-form',
...
'vendor.mail.text.panel','vendor.mail.text.subcopy','vendor.mail.text.table','welcome','e60dd9d2c3a62d619c9acb38f20d5aa5::accent',
