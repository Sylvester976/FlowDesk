            ...
            <div class="d-flex align-items-center gap-3 flex-wrap">
                ...
                <div>
                    ...
                    <div class="text-muted" style="font-size:.78rem;">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($staff->pf_number): ?> · PF: <?php echo e($staff->pf_number); ?> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        · Joined <?php echo e($staff->created_at->format('M Y')); ?>

                    </div>
                </div>
                <div class="ms-auto">
                    <span class="badge <?php echo e($staff->status === 'active' ? 'bg-success-subtle text-success border border-success-subtle' : 'bg-danger-subtle text-danger border border-danger-subtle'); ?>">
