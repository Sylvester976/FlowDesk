...
<div class="wrapper">
    ...
    <div class="body">
        <p style="font-size:15px;color:#374151;">Dear <?php echo e($recipient->first_name); ?>,</p>
        <p style="font-size:14px;color:#4a4a4a;line-height:1.7;">
            <?php echo e($applicant->full_name); ?> (<?php echo e($applicant->role?->label); ?>) has submitted a travel application.
        </p>
...
<?php /**PATH D:\Myprojects\FlowDesk\resources\views/emails/travel-notification.blade.php ENDPATH**/ ?>