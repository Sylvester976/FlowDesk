        ...
        <div class="col-12 col-lg-8">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="fw-medium">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($app->country): ?> <?php echo e($app->country->name); ?>

                                <?php elseif($app->county): ?> <?php echo e($app->county->name); ?> County
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($app->destination_details): ?>
                                    <span class="text-muted fw-normal"> &mdash; <?php echo e($app->destination_details); ?></span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                        ...
                        <div class="col-12">
                            ...
                            <div style="font-size:.88rem;line-height:1.8;white-space:pre-line;"><?php echo e($app->purpose); ?></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="p-3 d-flex align-items-start gap-3 <?php echo e(!$loop->last ? 'border-bottom' : ''); ?>">
                        ...
                        <div class="flex-grow-1">
                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                <span class="fw-medium" style="font-size:.88rem;"><?php echo e($cs->approver->full_name); ?></span>
                                <span class="text-muted" style="font-size:.78rem;"><?php echo e($cs->approver->role?->label); ?></span>
                                <?php
                                    $ac = match($cs->action) {
                                        'concurred'     => 'success',
                                ...
                                ?>
                                <span class="badge bg-<?php echo e($ac); ?>-subtle text-<?php echo e($ac); ?> border border-<?php echo e($ac); ?>-subtle"
