...
<p style="color:#374151;font-size:15px;margin:0 0 12px;">Hello <?php echo e($user->first_name); ?>,</p>
...
<div style="background:#e9f2ff;border:2px solid #004085;border-radius:10px;text-align:center;padding:28px;margin:20px 0;">
    <div style="font-size:2.8rem;font-weight:700;letter-spacing:.3em;color:#004085;font-family:monospace;"><?php echo e($code); ?></div>
