        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-12 col-sm-6">
                    <label class="form-label fw-medium">Destination Country <span class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($travel_type === 'local'): ?>
                <div class="col-12 col-sm-6">
                    <label class="form-label fw-medium">Destination County <span class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="col-12 col-sm-6">
                    <label class="form-label fw-medium">Departure Date <span class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="col-12 col-sm-6">
                    <label class="form-label fw-medium">
                        Per Diem Days <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isNairobi): ?><span class="text-danger">*</span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </label>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($travel_type === 'foreign_official'): ?>
                <div class="col-12 col-sm-6">
                    <label class="form-label fw-medium">Funding Source <span class="text-danger">*</span></label>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="card-title mb-0">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($travel_type === 'foreign_private'): ?>Leave &amp; <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?> Documents
            </h5>
        </div>
        <div class="card-body">
            ...
            <div class="p-4 rounded mb-4" style="background:#fff8e1;border:1px solid #f0c040;">
                ...
                <p style="font-size:.84rem;color:#78620a;margin-bottom:1rem;">
                    Foreign private travel requires approved annual leave. Has your leave been approved by HR?
                </p>
                <div class="d-flex flex-wrap gap-3">
                    <label class="d-flex align-items-center gap-2" style="cursor:pointer;">
                        <input type="radio" wire:model.live="leave_approved" value="1" class="form-check-input mt-0">
                        <span class="fw-medium" style="color:#006b3f;">
                            <i class="bi bi-check-circle me-1"></i>Yes, my leave is approved
                        </span>
                    </label>
                    <label class="d-flex align-items-center gap-2" style="cursor:pointer;">
                        <input type="radio" wire:model.live="leave_approved" value="0" class="form-check-input mt-0">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <div class="form-text">Bio-data page &mdash; PDF or image (JPG/PNG) &mdash; max 2MB</div>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <table style="width:100%;font-size:.85rem;">
                            ...
                            <tr>
                                ...
                                <td class="fw-medium pb-2">
                                    ...
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($destination_details): ?> &mdash; <?php echo e($destination_details); ?> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
                            </tr>
                            <tr>
                                <td class="text-muted pb-2">Dates</td>
                                <td class="fw-medium pb-2">
                                    <?php echo e(\Carbon\Carbon::parse($departure_date)->format('d M Y')); ?>

                                    &rarr; <?php echo e(\Carbon\Carbon::parse($return_date)->format('d M Y')); ?>
                    ...
                    <div class="p-3 rounded" style="background:var(--bs-tertiary-bg);font-size:.84rem;">
                        <div class="d-flex justify-content-between mb-1">
                            ...
                            <span class="fw-medium">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($country_id): ?> <?php echo e($countries->firstWhere('id', $country_id)?->name); ?>

                                <?php elseif($county_id): ?> <?php echo e($counties->firstWhere('id', $county_id)?->name); ?> County
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </span>
                        </div>
