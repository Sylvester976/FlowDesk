...
<div class="wrapper">
    ...
    <div class="body">
        ...
        <table>
            ...
            <tr><td>Applicant</td><td>{{ $applicant->full_name }}</td></tr>
            <tr>
                <td>Destination</td>
                <td>
                    @if($app->country) {{ $app->country->name }} @endif
                    @if($app->county) {{ $app->county->name }} County @endif
            ...
            <tr><td>Purpose</td><td>{{ Str::limit($app->purpose, 200) }}</td></tr>
        </table>
