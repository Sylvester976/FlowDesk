    ...
    <div id="content">
        ...
        <nav id="sidebar">
            ...
            <ul class="nav flex-column mt-3">
                <li class="nav-item">
                    <a class="nav-link active" href="{{ route('dashboard-staff') }}" data-section="dashboard">
                        <svg fill="currentColor" viewBox="0 0 24 24">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav flex-column collapse submenu" id="employeesMenu">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('assignment_add') }}" data-section="add-employee">
                                <svg fill="currentColor" viewBox="0 0 24 24">
                                    <path
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('assignHistory') }}" data-section="traveling">
                                <svg fill="currentColor" viewBox="0 0 24 24">
                                    <path
