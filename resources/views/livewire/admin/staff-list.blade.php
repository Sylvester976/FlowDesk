                        ...
                        <tr wire:key="staff-{{ $member->id }}">
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div>
                                        ...
                                        @if($member->pf_number)
                                            <div class="text-muted" style="font-size:.74rem;">PF: {{ $member->pf_number }}</div>
                                        @endif
                                        {{-- Mobile: show role + dept inline --}}
                                        <div class="d-md-none mt-1">
                                            <span class="badge bg-light text-dark border" style="font-size:.7rem;">{{ $member->role?->label }}</span>
                                            @if($member->department)
                                                <span class="text-muted" style="font-size:.74rem;"> · {{ $member->department->name }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                            ...
                            <td class="d-none d-lg-table-cell" style="font-size:.83rem;">
                                @if($member->department)
                                    ...
                                    <div class="text-muted" style="font-size:.75rem;">{{ $member->department->directorate?->name }}</div>
                                @else
