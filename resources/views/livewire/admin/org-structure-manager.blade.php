                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr wire:key="dir-{{ $dir->id }}">
                            ...
                            <td>
                                <span class="badge {{ $dir->is_active ? 'bg-success-subtle text-success border border-success-subtle' : 'bg-secondary-subtle text-secondary border border-secondary-subtle' }}"
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr wire:key="dept-{{ $dept->id }}">
                            ...
                            <td>
                                <span class="badge {{ $dept->is_active ? 'bg-success-subtle text-success border border-success-subtle' : 'bg-secondary-subtle text-secondary border border-secondary-subtle' }}"
                                    style="font-size:.75rem;">
            ...
            <div class="modal-body">
                <div class="row g-3">
                    <div class="col-12">
                        ...
                        @error('dir_name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-12 col-sm-4">
                        ...
                        <input type="text" wire:model="dir_code"
                            ...
                            placeholder="e.g. DI">
                        @error('dir_code')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
            ...
            <div class="modal-body">
                <div class="row g-3">
                    ...
                    <div class="col-12 col-sm-8">
                        ...
                        @error('dept_dir_id')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-12">
