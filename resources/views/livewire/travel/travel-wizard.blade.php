            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-sm-6">
                    <label class="form-label fw-medium">
                        Per Diem Days @if(!$isNairobi)<span class="text-danger">*</span>@endif
                    </label>
                    ...
                    @error('per_diem_days')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    <div class="form-text">
                        @if($isNairobi)
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="card-title mb-0">
                ...
                @if($travel_type === 'foreign_private')Leave &amp; @endif Documents
            </h5>
        </div>
        <div class="card-body">
            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-sm-6">
                    ...
                    @error('doc_invitation')<div class="invalid-feedback">{{ $message }}</div>@enderror
                ...
                <div class="col-12 col-sm-6">
                    ...
                    <input type="file" wire:model="doc_appointment"
                        ...
                        accept=".pdf,.jpg,.jpeg,.png,.PDF,.JPG,.JPEG,.PNG">
                    @error('doc_appointment')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    <div class="form-text">PDF or image (JPG/PNG) &mdash; max 2MB</div>
                </div>
                <div class="col-12 col-sm-6">
                    <label class="form-label fw-medium">
                    ...
                    <input type="file" wire:model="doc_passport"
                        ...
                        accept=".pdf,.jpg,.jpeg,.png,.PDF,.JPG,.JPEG,.PNG">
                    @error('doc_passport')<div class="invalid-feedback">{{ $message }}</div>@enderror
                ...
                <div class="col-12 col-sm-6">
                    ...
                    <input type="file" wire:model="doc_leave_form"
                        ...
                        accept=".pdf,.jpg,.jpeg,.png,.PDF,.JPG,.JPEG,.PNG">
                    @error('doc_leave_form')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    <div class="form-text">PDF or image (JPG/PNG) &mdash; max 2MB</div>
                </div>
                @endif
                        ...
                        <table style="width:100%;font-size:.85rem;">
                            ...
                            <tr>
                                ...
                                <td class="fw-medium pb-2">
                                    ...
                                    @endif
                                    @if($destination_details) &mdash; {{ $destination_details }} @endif
                                </td>
                            </tr>
                            <tr>
                                <td class="text-muted pb-2">Dates</td>
                                <td class="fw-medium pb-2">
                                    {{ \Carbon\Carbon::parse($departure_date)->format('d M Y') }}
                                    &rarr; {{ \Carbon\Carbon::parse($return_date)->format('d M Y') }}
                                </td>
                            </tr>
                    ...
                    <div class="p-3 rounded" style="background:var(--bs-tertiary-bg);font-size:.84rem;">
                        <div class="d-flex justify-content-between mb-1">
                            ...
                            <span class="fw-medium">
                                @if($country_id) {{ $countries->firstWhere('id', $country_id)?->name }}
                                @elseif($county_id) {{ $counties->firstWhere('id', $county_id)?->name }} County
                                @endif
                            </span>
                        </div>
