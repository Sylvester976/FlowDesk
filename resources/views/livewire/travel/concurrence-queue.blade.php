                        ...
                        <div class="row g-3 align-items-start">
                            ...
                            <span class="badge"
                                ...
                                <div class="mt-2 p-2 rounded"
                                     style="background:var(--bs-tertiary-bg);font-size:.82rem;line-height:1.6;">
                ...
                <div class="modal-content">
                    <div class="modal-header"
                        ...
                        <h5 class="modal-title"
                            style="color:{{ $action === 'concurred' ? '#006b3f' : ($action === 'not_concurred' ? '#bb0000' : '#78620a') }};">
                        ...
                        @if($action === 'not_concurred')
                            <div class="p-3 rounded mb-3" style="background:#ffebee;border-left:4px solid #bb0000;">
                                <p class="mb-0" style="font-size:.84rem;color:#7f0000;">
                                    ...
                                    Not concurring is final. The application will be rejected and the applicant cannot
                                    resubmit it.
                                </p>
                            </div>
                        @endif
