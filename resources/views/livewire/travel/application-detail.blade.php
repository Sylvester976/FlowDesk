                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-12 col-sm-6">
                                ...
                                <div class="fw-medium">
                                    ...
                                    @if($app->destination_details)
                                        <span
                                            class="text-muted fw-normal"> &mdash; {{ $app->destination_details }}</span>
                                    @endif
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                            ...
                            <div class="col-12">
                                ...
                                <div
                                    style="font-size:.88rem;line-height:1.8;white-space:pre-line;">{{ $app->purpose }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body p-0">
                            @foreach($app->concurrenceSteps as $cs)
                                <div
                                    class="p-3 d-flex align-items-start gap-3 {{ !$loop->last ? 'border-bottom' : '' }}">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="d-flex align-items-center gap-2 flex-wrap">
                                            <span class="fw-medium"
                                                  style="font-size:.88rem;">{{ $cs->approver->full_name }}</span>
                                            <span class="text-muted"
                                                  style="font-size:.78rem;">{{ $cs->approver->role?->label }}</span>
                                            @php
                                                $ac = match($cs->action) {
                                                    'concurred'     => 'success',
                                            ...
                                            @endphp
                                            <span
                                                class="badge bg-{{ $ac }}-subtle text-{{ $ac }} border border-{{ $ac }}-subtle"
