    ...
    <div class="page-header">
        <div>
            ...
            <nav class="breadcrumb">
                ...
                <a href="{{ route('travel.show', $app->id) }}" class="breadcrumb-item">{{ $app->reference_number }}</a>
            ...
            <div class="col-12 col-lg-8">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-sm-6">
                                <label class="form-label fw-medium">Per Diem Days <span class="text-danger">*</span></label>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <div class="text-muted mb-2" style="font-size:.78rem;text-transform:uppercase;letter-spacing:.04em;">Current documents</div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                @error('doc_invitation')<div class="text-danger small">{{ $message }}</div>@enderror
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <input type="file" wire:model="doc_appointment" class="form-control"
                                    accept=".pdf,.jpg,.jpeg,.png">
                                @error('doc_appointment')<div class="text-danger small">{{ $message }}</div>@enderror
                                <div class="form-text">Leave empty to keep existing</div>
                            </div>
                            <div class="col-12 col-sm-6">
                                ...
                                <input type="file" wire:model="doc_passport" class="form-control"
                                    accept=".pdf,.jpg,.jpeg,.png">
                                @error('doc_passport')<div class="text-danger small">{{ $message }}</div>@enderror
                                <div class="form-text">Leave empty to keep existing</div>
                            </div>
                            @endif
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <input type="file" wire:model="doc_leave_form" class="form-control"
                                    accept=".pdf,.jpg,.jpeg,.png">
                                @error('doc_leave_form')<div class="text-danger small">{{ $message }}</div>@enderror
                                <div class="form-text">Leave empty to keep existing</div>
                            </div>
                            @endif
